...
//    { 0.0f, 0.0f, 0.0f, 1.0f };
    ...
    {
        gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_AMBIENT, kd, 0);
        gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_DIFFUSE, kd, 0);
        gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_SPECULAR, ks, 0);
        gl.glMaterialf(GL10.GL_FRONT_AND_BACK, GL10.GL_SHININESS, Math.min(Math.max(ns, 0), 128));
    ...
    {
        return "Material[" + "name=\"" + name + "\"," + "ka={" + ka[0] + "," + ka[1] + "," + ka[2] + "}," + "kd={" + kd[0] + "," + kd[1] + "," + kd[2] + "}," + "ks={" + ks[0] + "," + ks[1] + "," + ks[2] + "}," + "ns=" + ns + "," + "map_kd=\""
                + (map_kd == null ? "" : map_kd) + "\"," + "illum=" + illum + "," + "d=" + d + "]";
    }
}
