...
public class Group {
    ...
    public void draw(GL10 gl) {
        ...
        gl.glVertexPointer(3, GL10.GL_FIXED, 0, parent.getVertexBuffer());
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);

        gl.glNormalPointer(GL10.GL_FIXED, 0, parent.getNormalBuffer());
        gl.glEnableClientState(GL10.GL_NORMAL_ARRAY);

        if (parent.hasTexcoords()) {
            gl.glTexCoordPointer(2, GL10.GL_FIXED, 0, parent.getTexcoordBuffer());
