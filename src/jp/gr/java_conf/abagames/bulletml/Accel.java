...
/**
 * <b>Accel</b> is generated by Relaxer based on bulletml.rlx.
 ...
 */
public class Accel implements java.io.Serializable, IRNSContainer, IRNode, IActionChoice
{
    ...
    public void makeElement(Node parent)
    {
        ...
        Element element = doc.createElementNS("http://www.asahi-net.or.jp/~cs8k-cyu/bulletml", "accel");
    ...
    public final void setHorizontal(Horizontal horizontal)
    {
        ...
        if (horizontal != null)
        {
            horizontal.setParentRNode(this);
        }
    }
    ...
    public void makeTextElement(StringBuffer buffer)
    {
        ...
        buffer.append("<");
        URelaxer.makeQName(prefix, "accel", buffer);
    ...
    public IRNode[] getRNodes()
    {
        ...
        if (horizontal_ != null)
        {
            classNodes.add(horizontal_);
        }

        if (vertical_ != null)
        {
            classNodes.add(vertical_);
        }
    ...
    {
        if (!URelaxer2.isTargetElement(element, "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml", "accel"))
        {
            return (false);
        }
